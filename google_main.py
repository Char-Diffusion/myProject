...
import google_configs
import google_datasets

# this registers the diffusion task
import google_diffusion  # pylint: disable=unused-import
import google_models
import google_tasks
import google_trainers
import google_utils
...
def run_experiment(
    model_dir,
    model_cls=google_models.CategoricalDiffusionModel,
    task_name='diffusion',
    dataset_name='lm1b',
  ...
  task = google_tasks.load(name=task_name)
  ...
  trainer = google_trainers.Trainer(
